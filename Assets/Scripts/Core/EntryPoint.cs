...
public class EntryPoint : MonoBehaviour
{
    ...
    private void CreateObjects()
    {
        ...
        //«апутанный пор€док инициализации с GameManager, GameMenu и его вкладками
    ...
    public void InitializePlayerDataFromSave()
    {
        ...
        {
            newGame = false;
            Debug.Log($"EntryPoint: »гра загружена из профил€ {SaveSystem.CurrentProfileIndex}.");
        }
        else
        {
            Debug.Log($"EntryPoint: —охранение из профил€ {SaveSystem.CurrentProfileIndex} не найдено. Ќова€ игра.");
            ...
            SaveSystem.Save();
            SaveSystem.AutoSave();
            _playerInstance.gameObject.GetComponent<Rigidbody2D>().bodyType = RigidbodyType2D.Static; // Ќиебический костыль, надо будет как то потом поправить
        }
    ...
    {
        //  оординаты начальной комнаты (только если нет сохраненной позиции)
