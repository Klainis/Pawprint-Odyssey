...
//{
//    [Header("ќсновные параметры атаки")]
//    [SerializeField] private int dmgValue = 1;
//    [SerializeField] private float attackSeriesTimeout = 0.9f; // врем€, за которое можно нажать след. удар в серии
//    [SerializeField] private int maxAttackSeriesCount = 3;
//    [SerializeField] private float forceFromAttack = 600f;

//    [SerializeField] Camera cam;
//    [SerializeField] private InputActionReference rawAction;
